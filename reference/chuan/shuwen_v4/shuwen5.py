...
class CFG:
    num_workers=2
    path="/kaggle/input/common-nlp-tokenizer/model_tokenizer/tiny/deberta_base/"
...
for fold in CFG.trn_fold:
    ...
    state = torch.load(f"/kaggle/input/shuwen-tiny-model/shuwen_deberta_base/shuwen_{fold}.pth",
...
submission[['text_id'] + CFG.target_cols].to_csv('./out/deberta_base.csv', index=False)
