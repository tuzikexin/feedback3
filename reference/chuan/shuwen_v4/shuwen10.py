...
class CFG:
    num_workers=2
    path="/kaggle/input/common-nlp-tokenizer/model_tokenizer/pseudo_deberta_v2_xlarge_c1/"
...
# tokenizer
# ====================================================
CFG.tokenizer = AutoTokenizer.from_pretrained('../input/deberta-v2-xlarge')
...
for fold in CFG.trn_fold:
    ...
    state = torch.load(f'/kaggle/input/shuwen-pseudo-debertav2xl/shuwen_pseudo_deberta_v2_xlarge_c1/shuwen_{fold}.pth',
...
submission[['text_id'] + CFG.target_cols].to_csv('./out/pseudo_deberta_v2_xlarge.csv', index=False)
