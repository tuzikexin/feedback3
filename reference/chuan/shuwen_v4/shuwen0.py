...
class CFG:
    num_workers=4
    path="/kaggle/input/common-nlp-tokenizer/model_tokenizer/tiny/lsg_electra_base/"
    config_path=path+'config.pth'
    model="../input/lsg-model/lsg-electra-base/"
...
for fold in CFG.trn_fold:
    ...
    state = torch.load(f'/kaggle/input/shuwen-tiny-model/shuwen_lsg_electra_base/shuwen_{fold}.pth',
...
submission[['text_id'] + CFG.target_cols].to_csv('./out/lsg_electra_base.csv', index=False)
