...
class CFG:
    num_workers=4
    path="/kaggle/input/common-nlp-tokenizer/model_tokenizer/deberta_v3_large_c1/"
...
for fold in CFG.trn_fold:
    ...
    state = torch.load(f'/kaggle/input/shuwen-debertav3large-model/shuwen_deberta_v3_large_c1/shuwen_{fold}.pth',
...
submission[['text_id'] + CFG.target_cols].to_csv('./out/deberta_v3_large.csv', index=False)
