...
class CFG:
    num_workers=2
    path="/kaggle/input/common-nlp-tokenizer/model_tokenizer/deberta_v2_xlarge_c1/"
...
for fold in CFG.trn_fold:
    ...
    state = torch.load(f'/kaggle/input/shuwen-debertav2xl/shuwen_deberta_v2_xlarge_c1/shuwen_{fold}.pth',
...
submission[['text_id'] + CFG.target_cols].to_csv('./out/deberta_v2_xlarge.csv', index=False)
