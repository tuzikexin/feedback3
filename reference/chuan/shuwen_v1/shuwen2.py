...
class CFG:
    num_workers=4
    path="/kaggle/input/common-nlp-tokenizer/model_tokenizer/tiny/deberta_v3_small/"
...
for fold in CFG.trn_fold:
    ...
    state = torch.load(f'/kaggle/input/shuwen-tiny-model/shuwen_deberta_v3_small/shuwen_{fold}.pth',
...
submission[['text_id'] + CFG.target_cols].to_csv('./out/deberta_v3_small.csv', index=False) 
