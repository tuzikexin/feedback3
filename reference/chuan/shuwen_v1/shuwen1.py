...
class CFG:
    num_workers=4
    path="/kaggle/input/common-nlp-tokenizer/model_tokenizer/tiny/lsg_base_4096/"
    config_path=path+'config.pth'
    model="../input/lsg-model/lsg-base-4096/"
...
for fold in CFG.trn_fold:
    ...
    state = torch.load(f'/kaggle/input/shuwen-tiny-model/shuwen_lsg_base_4096/shuwen_{fold}.pth',
...
submission[['text_id'] + CFG.target_cols].to_csv('./out/lsg_base_4096.csv', index=False)
