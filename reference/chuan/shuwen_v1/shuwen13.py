...
class CFG:
    num_workers=2
    path="/kaggle/input/common-nlp-tokenizer/model_tokenizer/lsg_roberta_large_c1/"
    config_path=path+'config.pth'
    model="../input/lsg-model/lsg-roberta-large"
...
for fold in CFG.trn_fold:
    ...
    state = torch.load(f'/kaggle/input/shuwen-lsg-roberta-large/shuwen_lsg_roberta_large_c1/shuwen_{fold}.pth',
...
submission[['text_id'] + CFG.target_cols].to_csv('./out/lsg_roberta_large_c1.csv', index=False)
